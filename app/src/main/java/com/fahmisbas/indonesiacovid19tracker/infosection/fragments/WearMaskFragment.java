...
public class WearMaskFragment extends Fragment {
    ...
    private void setToolbarTitle() {
        ...
        toolbar_title.setText(R.string.toolbar_title_howmask);
    ...
    private void processingJSON() {
        try {
            if (getActivity() != null) {
                ...
                String question = sharedPreferences.getString("wearMask", null);
    ...
    private void initRecyclerview() {
        RecyclerView rvmask = view.findViewById(R.id.rv_wearMask);
        AdviceAdapter adapter = new AdviceAdapter(wearMaskList);
        rvmask.setAdapter(adapter);
    }
